 ...
 * });
 */
export function useGetAnimeTitleQuery(
  baseOptions?: Apollo.QueryHookOptions<GetAnimeTitleQuery, GetAnimeTitleQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetAnimeTitleQuery, GetAnimeTitleQueryVariables>(
    GetAnimeTitleDocument,
    options
  )
}
export function useGetAnimeTitleLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetAnimeTitleQuery, GetAnimeTitleQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetAnimeTitleQuery, GetAnimeTitleQueryVariables>(
    GetAnimeTitleDocument,
    options
  )
}
export function useGetAnimeTitleSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<GetAnimeTitleQuery, GetAnimeTitleQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions }
  return Apollo.useSuspenseQuery<GetAnimeTitleQuery, GetAnimeTitleQueryVariables>(
    GetAnimeTitleDocument,
    options
  )
}
...
export type GetAnimeTitleQueryResult = Apollo.QueryResult<
  GetAnimeTitleQuery,
  GetAnimeTitleQueryVariables
>
...
export function useGetAnimeListSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<GetAnimeListQuery, GetAnimeListQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions }
